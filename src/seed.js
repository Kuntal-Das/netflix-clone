export function seedDatabase(firebase) {
  ...
  console.log("Crub Your Enthusiasm");
  ...
  console.log("The Confession Killer");
  ...
  console.log("The Social Network");
  ...
  console.log("Hotel Transylvania");
